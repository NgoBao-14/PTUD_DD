<div class="main">
        <div class="search1">
            ...
            <div class="img">
                <img width="600" height="500" src="./public/img/banner.png" alt="">
            </div>
        </div>
        <!-- Booking bác sĩ -->
        <div class="listbs">
                        ...
                        <div class="bv_card">
                            <a href="" style="text-decoration: none">
                                ...
                                <div class="bv_info">
                                    ...
                                    <ul class="time">
                                        <li style="text-align:left;">Thứ 2 - Thứ 6:  7h30 - 16h30 </li>
                                        <li style="text-align:left;">Thứ 7 - CN:     7h30 - 11h30 </li>
                                    </ul>
                                </div>
                            </a>
                        </div>
